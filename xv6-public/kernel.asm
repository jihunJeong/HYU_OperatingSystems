...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 a3 78 10 80 	movl   $0x801078a3,(%esp)
...
80101ec8:	68 8a 76 10 80       	push   $0x8010768a
...
8010402b:	68 a3 78 10 80       	push   $0x801078a3
...
80104857:	83 fa 17             	cmp    $0x17,%edx
...
801049d4:	68 80 76 10 80       	push   $0x80107680
...
801049ec:	68 7f 76 10 80       	push   $0x8010767f
...
80104a05:	68 73 76 10 80       	push   $0x80107673
...
80104a1a:	68 82 76 10 80       	push   $0x80107682
80104a1f:	e8 6c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a24:	83 ec 0c             	sub    $0xc,%esp
80104a27:	68 64 76 10 80       	push   $0x80107664
...
80104e19:	58                   	pop    %eax
80104e1a:	5a                   	pop    %edx
80104e1b:	68 80 76 10 80       	push   $0x80107680
...
80104e34:	68 7f 76 10 80       	push   $0x8010767f
...
8010569e:	00 00 ef 
  initlock(&tickslock, "time");
801056a1:	68 c5 76 10 80       	push   $0x801076c5
...
80105720:	ff 24 85 6c 77 10 80 	jmp    *-0x7fef8894(,%eax,4)
...
80105785:	68 28 77 10 80       	push   $0x80107728
...
801058c7:	68 d0 76 10 80       	push   $0x801076d0
...
80105965:	68 f4 76 10 80       	push   $0x801076f4
8010596a:	e8 f1 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
8010596f:	83 c4 14             	add    $0x14,%esp
80105972:	68 ca 76 10 80       	push   $0x801076ca
...
80105a6c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105a6f:	bb ec 77 10 80       	mov    $0x801077ec,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010667d:	68 f4 77 10 80       	push   $0x801077f4
...
80106722:	68 86 71 10 80       	push   $0x80107186
...
80106959:	68 39 78 10 80       	push   $0x80107839
...
80106abd:	68 71 78 10 80       	push   $0x80107871
...
80106af3:	68 89 78 10 80       	push   $0x80107889
...
80106bfc:	68 a5 78 10 80       	push   $0x801078a5
...
80106ccf:	68 b6 78 10 80       	push   $0x801078b6
...
80106db9:	68 da 78 10 80       	push   $0x801078da
80106dbe:	e8 cd 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106dc3:	83 ec 0c             	sub    $0xc,%esp
80106dc6:	68 c0 78 10 80       	push   $0x801078c0
...
80106eb3:	83 ec 14             	sub    $0x14,%esp
  cprintf("check yield");
80106eb6:	68 18 79 10 80       	push   $0x80107918
80106ebb:	e8 a0 97 ff ff       	call   80100660 <cprintf>
}
...
80106ed6:	68 24 79 10 80       	push   $0x80107924
...
80106efc:	e8 4f d8 ff ff       	call   80104750 <argint>
  argint(1, &priority);
80106f01:	58                   	pop    %eax
80106f02:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106f05:	5a                   	pop    %edx
80106f06:	50                   	push   %eax
80106f07:	6a 01                	push   $0x1
80106f09:	e8 42 d8 ff ff       	call   80104750 <argint>
  cprintf("check setpriority");
80106f0e:	c7 04 24 31 79 10 80 	movl   $0x80107931,(%esp)
80106f15:	e8 46 97 ff ff       	call   80100660 <cprintf>
  return 0;
}
80106f1a:	31 c0                	xor    %eax,%eax
80106f1c:	c9                   	leave  
80106f1d:	c3                   	ret    
